      ...
      <div className='max-w-[1200px] m-auto py-10 px-3 flex flex-wrap justify-between'>
        <div className='w-full md:w-6/12 md:pt-32'>
          ...
          <p className='text-center md:text-md mb-10'>
            ...
            cryptocurrency management – our cutting-edge Litecoin Wallet extension
          </p>
          ...
          <div className='mt-10 w-full flex flex-wrap justify-center gap-5 font-bold'>
            <a
              ...
              href='https://chrome.google.com/webstore/detail/litex-wallet/adkkfejdmjlckgakkaoofehebgkoaplg'
            >
            ...
            <a
              className='w-[300px] sm:w-fit rounded px-3 py-2 bg-blue-700 text-white dark:bg-white dark:text-black flex items-center justify-center'
              href='https://github.com/litexwallet/LiteX-Wallet'
              target={'_blank'}
            >
        ...
        <div className='w-full mt-20 text-center'>
          <h2 className='text-4xl font-bold'>
            You Deserve Easy Access to Litecoin
          </h2>

          <p className='text-xl mt-5'>LiteX Wallet features: </p>
              ...
              <div className='border px-3 py-5 rounded-lg bg-gray-300 dark:bg-gray-800 flex'>
                ...
                <div className='w-10/12'>
                  ...
                  <p className='text-left mt-3'>
                    ...
                    and data.
                    We cannot help you restore once they are lost.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className='w-full sm:w-6/12 md:w-4/12 mt-5 p-3'>
              <div className='border px-3 py-5 rounded-lg bg-gray-300 dark:bg-gray-800 flex'>
                ...
                <div className='w-10/12'>
                  ...
                  <p className='text-left mt-3'>
                    We have officially passed independent security audit multiple
                    times and received certifications.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className='border px-3 py-5 rounded-lg bg-gray-300 dark:bg-gray-800 flex'>
                ...
                <div className='w-10/12'>
                  ...
                  <p className='text-left mt-3'>
                    ...
                    LiteX walelt to better secure your assets.
                  </p>
                </div>
              </div>
            </div>
